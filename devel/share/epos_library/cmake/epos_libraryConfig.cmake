...
if(NOT "/home/dlab/ros_ws/src/epos_hardware/epos_library/include " STREQUAL " ")
  set(epos_library_INCLUDE_DIRS "")
  set(_include_dirs "/home/dlab/ros_ws/src/epos_hardware/epos_library/include")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'epos_library' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/dlab/ros_ws/src/epos_hardware/epos_library/${idir}'.  Ask the maintainer 'Mitchell Wills <mwills@wpi.edu>' to fix it.")
    endif()
