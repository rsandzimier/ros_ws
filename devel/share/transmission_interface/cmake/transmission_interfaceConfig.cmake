...
if(NOT "/home/dlab/ros_ws/src/transmission_interface/include;/usr/include " STREQUAL " ")
  set(transmission_interface_INCLUDE_DIRS "")
  set(_include_dirs "/home/dlab/ros_ws/src/transmission_interface/include;/usr/include")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'transmission_interface' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/dlab/ros_ws/src/transmission_interface/${idir}'.  Ask the maintainer 'Adolfo Rodriguez Tsouroukdissian <adolfo.rodriguez@pal-robotics.com>, Dave Coleman <davetcoleman@gmail.com>' to fix it.")
    endif()
