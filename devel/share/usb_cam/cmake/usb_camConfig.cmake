...
if(NOT "/home/dlab/ros_ws/src/usb_cam/include " STREQUAL " ")
  set(usb_cam_INCLUDE_DIRS "")
  set(_include_dirs "/home/dlab/ros_ws/src/usb_cam/include")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'usb_cam' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/dlab/ros_ws/src/usb_cam/${idir}'.  Ask the maintainer 'Russell Toris <rctoris@wpi.edu>' to fix it.")
    endif()
