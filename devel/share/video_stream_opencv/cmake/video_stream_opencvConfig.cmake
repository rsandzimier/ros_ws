...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'video_stream_opencv' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/dlab/ros_ws/src/video_stream_opencv/${idir}'.  Ask the maintainer 'Sammy Pfeiffer <Sammy.Pfeiffer@student.uts.edu.au>' to fix it.")
    endif()
