...
if(NOT "/home/dlab/ros_ws/src/controller_interface/include " STREQUAL " ")
  set(controller_interface_INCLUDE_DIRS "")
  set(_include_dirs "/home/dlab/ros_ws/src/controller_interface/include")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'controller_interface' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/dlab/ros_ws/src/controller_interface/${idir}'.  Ask the maintainer 'Adolfo Rodriguez Tsouroukdissian <adolfo.rodriguez@pal-robotics.com>' to fix it.")
    endif()
