...
if(NOT "/home/dlab/ros_ws/src/hardware_interface/include " STREQUAL " ")
  set(hardware_interface_INCLUDE_DIRS "")
  set(_include_dirs "/home/dlab/ros_ws/src/hardware_interface/include")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'hardware_interface' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/dlab/ros_ws/src/hardware_interface/${idir}'.  Ask the maintainer 'Adolfo Rodriguez Tsouroukdissian <adolfo.rodriguez@pal-robotics.com>' to fix it.")
    endif()
