...
set_target_properties(realsense::realsense PROPERTIES
  ...
  IMPORTED_LOCATION_NOCONFIG "${_IMPORT_PREFIX}/lib/librealsense.so.1.12.3"
  IMPORTED_SONAME_NOCONFIG "librealsense.so.1"
  )

list(APPEND _IMPORT_CHECK_TARGETS realsense::realsense )
list(APPEND _IMPORT_CHECK_FILES_FOR_realsense::realsense "${_IMPORT_PREFIX}/lib/librealsense.so.1.12.3" )
