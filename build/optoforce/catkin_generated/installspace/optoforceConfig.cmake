...
if(NOT " " STREQUAL " ")
  ...
  set(_include_dirs "")
  if(NOT "https://github.com/shadow-robot/optoforce/issues " STREQUAL " ")
    set(_report "Check the issue tracker 'https://github.com/shadow-robot/optoforce/issues' and consider creating a ticket if the problem has not been reported yet.")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'optoforce' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/dlab/ros_ws/install/${idir}'.  ${_report}")
    endif()
