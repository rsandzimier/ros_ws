...
if(NOT "include " STREQUAL " ")
  ...
  elseif(NOT " " STREQUAL " ")
    ...
    set(_report "Report the problem to the maintainer 'Brian Axelrod <baxelrod.rosmaint@mit.edu>' and request to fix the problem.")
  endif()
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'dynamixel_pro_controller' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  ${_report}")
      endif()
    else()
      message(FATAL_ERROR "Project 'dynamixel_pro_controller' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/dlab/ros_ws/install/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/dlab/ros_ws/install/lib;/opt/ros/kinetic/lib)
...
set(dynamixel_pro_controller_EXPORTED_TARGETS "dynamixel_pro_controller_generate_messages_cpp;dynamixel_pro_controller_generate_messages_eus;dynamixel_pro_controller_generate_messages_lisp;dynamixel_pro_controller_generate_messages_nodejs;dynamixel_pro_controller_generate_messages_py")
...
foreach(depend ${depends})
  ...
  if(${count} EQUAL 1)
    ...
    if(NOT ${dynamixel_pro_controller_dep}_FOUND)
      find_package(${dynamixel_pro_controller_dep} REQUIRED NO_MODULE)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${dynamixel_pro_controller_dep} REQUIRED NO_MODULE ${depend_list})
  endif()
