...
if("FALSE" STREQUAL "TRUE")
  set(epos_hardware_SOURCE_PREFIX /home/dlab/ros_ws/src/epos_hardware/epos_hardware)
  set(epos_hardware_DEVEL_PREFIX /home/dlab/ros_ws/devel)
  ...
  set(epos_hardware_INSTALL_PREFIX /home/dlab/ros_ws/install)
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'epos_hardware' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'Mitchell Wills <mwills@wpi.edu>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'epos_hardware' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/dlab/ros_ws/install/${idir}'.  Ask the maintainer 'Mitchell Wills <mwills@wpi.edu>' to fix it.")
    endif()
...
foreach(depend ${depends})
  ...
  if(${count} EQUAL 1)
    ...
    if(NOT ${epos_hardware_dep}_FOUND)
      find_package(${epos_hardware_dep} REQUIRED)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${epos_hardware_dep} REQUIRED ${depend_list})
  endif()
