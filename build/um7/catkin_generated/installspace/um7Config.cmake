...
if("FALSE" STREQUAL "TRUE")
  set(um7_SOURCE_PREFIX /home/dlab/ros_ws/src/um7)
  set(um7_DEVEL_PREFIX /home/dlab/ros_ws/devel)
  set(um7_INSTALL_PREFIX "")
  set(um7_PREFIX ${um7_DEVEL_PREFIX})
else()
  set(um7_SOURCE_PREFIX "")
  set(um7_DEVEL_PREFIX "")
  set(um7_INSTALL_PREFIX /home/dlab/ros_ws/install)
...
if(NOT "include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'um7' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/dlab/ros_ws/install/${idir}'.  Ask the maintainer 'Daniel Miller <dgmiller@ncsu.edu>, Tony Baltovski <tbaltovski@clearpathrobotics.com>' to fix it.")
    endif()
